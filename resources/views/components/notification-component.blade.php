...
@push('js')
    <script>
        ...
        window.livewire.on('success_message', (message) => {
            success_message(message)
        });
        window.livewire.on('info_message', (message) => {
            info_message(message)
        });
        window.livewire.on('alert_message', (message) => {
            alert_message(message)
        });
        window.livewire.on('error_message', (message) => {
